        ...
        <div className="w-full min-h-screen flex flex-col bg-gray-950 text-gray-300">
            ...
            <header className="w-full py-4 bg-gray-900 shadow-md border-b border-gray-800">
                <div className="container mx-auto px-4 md:px-10 flex justify-between items-center">
                    ...
                    <nav>
                        <Link to="/chat">
                            <button className="px-4 py-1.5 border border-blue-600 text-blue-500 bg-transparent rounded-lg shadow-sm hover:bg-blue-600 hover:text-white hover:shadow-md transition-all duration-200 ease-in-out outline-none">
                                Start Chat
                            </button>
                        </Link>
                    </nav>
            ...
            <section className="flex-1 flex flex-col items-center justify-center text-center px-4 my-16 sm:my-20 md:my-28">
                ...
                <Link to="/chat">
                    <button className="px-6 py-2.5 border border-blue-600 text-blue-500 bg-transparent rounded-lg shadow-sm hover:bg-blue-600 hover:text-white hover:shadow-md transition-all duration-200 ease-in-out outline-none">
                        Start Chatting Now
                    </button>
                </Link>
            </section>
